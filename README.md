...
Run on the GDG Compiler for proper and easy output.
...
•	Press 'q' + Enter to stop the simulation. A new log file will then be created containing the complete session history.
...
•	When simulation is ended with 'q' + Enter, a separate log file containing the full session history is generated.
